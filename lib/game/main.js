...
MyTitle = ig.Game.extend({
  ...
  music: new ig.Sound( 'media/music/HorseSteppin.*', false ),
  ...
  init: function() {
    ...
    ig.gamepadInput.onControllerAdded(function(pad) {
      ig.game.spawnEntity( EntityPlayer, 0, 0, {controllerNumber: pad} );
    });
